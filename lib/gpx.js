import garmin from '@furkot/garmin-data';
import galileo from '@furkot/guru-data';
import osmand from '@furkot/osmand-data';
import { generator } from 'gexode';
import { getComment, getDeparture, getSchema, getTimestamp, isStop, streetAddress } from './tools.js';
